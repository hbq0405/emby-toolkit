...
from .media import task_role_translation, task_populate_metadata_cache, task_execute_auto_tagging_rules, task_scan_monitor_folders, task_restore_nfo_and_images, task_backup_mediainfo, task_restore_mediainfo, task_contribute_mediainfo_to_center
...
def get_task_registry(context: str = 'all'):
    ...
    full_registry = {
        ...
        'restore_nfo_and_images': (task_restore_nfo_and_images, "恢复媒体数据", 'media', True),
