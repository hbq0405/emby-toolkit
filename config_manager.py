...
DYNAMIC_CONFIG_DEF = {
    ...
    # [LocalOrganize] 
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_ENABLED: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'boolean', False),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_SOURCE_MOVIE: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'string', ""),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_SOURCE_TV: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'string', ""),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_SOURCE_MIXED: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'string', ""),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_TARGET_BASE: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'string', ""),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_MODE: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'string', "hardlink"),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_AUTO_SCRAPE: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'boolean', True),
    constants.CONFIG_OPTION_LOCAL_ORGANIZE_MAX_WORKERS: (constants.CONFIG_SECTION_LOCAL_ORGANIZE, 'int', 5),
    ...
    constants.CONFIG_OPTION_115_GENERATE_MEDIAINFO: (constants.CONFIG_SECTION_115, 'boolean', False),
