...
DYNAMIC_CONFIG_DEF = {
    ...
    constants.CONFIG_OPTION_GAP_FILL_RESUBSCRIBE_ENABLED: (constants.CONFIG_SECTION_MOVIEPILOT, 'boolean', False),
    ...
    constants.CONFIG_OPTION_MOVIE_SUBSCRIPTION_DELAY_DAYS: (constants.CONFIG_SECTION_MOVIEPILOT, 'int', 30),
    constants.CONFIG_OPTION_AUTOCANCEL_SUBSCRIBED_DAYS: (constants.CONFIG_SECTION_MOVIEPILOT, 'int', 0),
