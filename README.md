...
一个用于处理和增强 Emby 媒体库的工具，包括但不限于演员/角色名称翻译、信息补全（从豆瓣、TMDb等）、合集检查及订阅、智能追剧、演员订阅、自建合集、115网盘管理、302直链播放、虚拟库。

📖 **项目文档**: [点击查看 Wiki](https://hbq0405.github.io/emby-toolkit/zh/)
💬 **交流群组**: [![Telegram](https://img.shields.io/badge/Telegram-加入群组-2CA5E0?logo=telegram&logoColor=white)](https://t.me/emby_toolkit)
