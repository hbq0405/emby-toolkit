...
const allBlocks = [
  ...
  { id: 'season_name_zh', label: '中文季号 (第 1 季)' },
  { id: 'episode_name_zh', label: '中文集号 (第 1 集)' },
  { id: 's_e_zh', label: '中文季集号 (第 1 季 1 集)' },
...
const buildName = (mockData, formatArray, isTv) => {
  ...
  for (const rawId of formatArray) {
    ...
    else if (blockId === 'episode_name_zh' && isTv) val = `第 ${mockData.e} 集`;
    else if (blockId === 's_e_zh' && isTv) val = `第 ${mockData.s} 季 ${mockData.e} 集`;
