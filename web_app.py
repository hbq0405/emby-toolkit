...
def emby_webhook():
    ...
    if event_type in USER_DATA_EVENTS:
        ...
        if item_type_from_webhook in ['Movie', 'Series']: # 剧集容器的收藏状态也需要记录
