...
CONFIG_OPTION_115_COPY_PLAY_TEMP_CID = "p115_copy_play_temp_cid" # 复制播放临时目录CID
CONFIG_OPTION_115_COPY_PLAY_TEMP_NAME = "p115_copy_play_temp_name" # 复制播放临时目录名称
