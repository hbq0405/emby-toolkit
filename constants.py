...
CONFIG_OPTION_115_SHARED_RESOURCE_ENABLED = "p115_shared_resource_enabled" # 是否启用共享资源中心
CONFIG_OPTION_115_SHARED_CENTER_URL = "p115_shared_center_url" # 共享资源中心地址（隐藏配置，默认官方中心）
CONFIG_OPTION_115_SHARED_DEVICE_TOKEN = "p115_shared_device_token" # 共享资源中心设备Token（隐藏配置）
CONFIG_OPTION_115_SHARED_RESOURCE_MODE = "p115_shared_resource_mode" # 共享资源入库方式：permanent/virtual
...
CONFIG_OPTION_115_SHARED_MAX_ACTIVE_SHARES = "p115_shared_max_active_shares" # 共享资源本机最大活跃分享数，0 表示不限制
