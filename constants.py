...
CONFIG_OPTION_115_SHARE_ENABLED = "p115_share_enabled"               # 分享挂载总开关
CONFIG_OPTION_115_SHARE_LOCAL_DIR = "p115_share_local_dir"           # 分享挂载STRM本地保存目录
CONFIG_OPTION_115_SHARE_LINKS = "p115_share_links"                   # 分享链接列表
CONFIG_OPTION_115_SHARE_TRANSFER_CID = "p115_share_transfer_cid"     # 分享动态转存临时目录CID
CONFIG_OPTION_115_SHARE_TRANSFER_NAME = "p115_share_transfer_name"   # 分享动态转存临时目录名称
CONFIG_OPTION_115_SHARE_AUTO_CLEANUP = "p115_share_auto_cleanup"     # 是否自动清理临时转存目录 (0空间占用核心)
CONFIG_OPTION_115_SHARE_CLEANUP_HOURS = "p115_share_cleanup_hours"   # 临时文件保留时间(小时)
