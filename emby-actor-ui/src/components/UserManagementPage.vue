...
<template>
  <div class="user-management-page">
    ...
    <n-alert title="操作提示" type="info" style="margin-top: 15px; margin-bottom: 20px;">
      <template #default>
        <ul>
          <li><strong>第一步：创建模板用户。</strong>请先在Emby后台创建模板用户，为每个模板用户分配相应的权限，如果后期更改了模板用户权限，记得同步权限，请勿用正常用户作为模板源用户。</li>
          <li><strong>第二步：创建模板。</strong>然后在本工具【用户模板】标签页中以模板用户为源用户创建一个权限模板。模板是用户权限的“样板”，决定了他们注册后的所有权限设置。</li>
